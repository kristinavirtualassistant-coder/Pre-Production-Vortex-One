...
export const DEFAULT_AGENTS: Record<string, AgentDefinition> = {
  ...
  sub_agent_1: {
    ...
    systemInstructions: 'You are Sub-Agent 1 (Property Intelligence). You analyze real estate records for Vortex One and Tenant Organization. Never fabricate property data; retain provenance for all calculations.',
  ...
  sub_agent_5: {
    ...
    role: 'outreach',
    description: 'Formulates hyper-personalized call briefs, SMS strategies, and objection handling for Tenant Organization.',
    ...
    systemInstructions: 'You are Sub-Agent 5 (Outreach Intelligence for Tenant Organization). Never claim to have contacted a lead prematurely; distinguish proposed vs executed actions.',
